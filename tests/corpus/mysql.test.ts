...
import { KNOWN_BAD } from "../mysql-corpus-known-bad.js";

// The MySQL conformance corpus (gitignored, skipped when absent):
//
...
//   the grammar's own positives. A mysql/docs scrape (the vendor manual's examples) is a tracked Open
//   Gap, not present here.
