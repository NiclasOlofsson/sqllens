...
const IN_SCOPE_POSITIVE_BASELINE = 2624; // in-scope parsed of 2645; 21 in-scope still failing
const IN_SCOPE_NEGATIVE_BASELINE = 1847; // in-scope rejected of 2061; 214 in-scope still accepted
