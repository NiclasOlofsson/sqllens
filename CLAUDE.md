...
src/ir/ir.ts               dialect-neutral IR (QueryExpr/SelectExpr/SetOpExpr/PipeExpr/Source/Expr…; PipeExpr = base + ordered PipeStage[]; GraphTableSource for GQL); every node keeps a cst back-ref for source spans, and Projection.aliasCst the alias identifier's own span
