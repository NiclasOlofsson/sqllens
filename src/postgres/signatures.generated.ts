...
export const POSTGRES_SIGNATURES: Record<string, FnSignature> = {
	...
	brin_summarize_new_values: {
		...
		params: [{ name: "index", type: "regclass" }],
		origin: "harvested",
	}, // func.sgml
	...
	current_schemas: {
		...
		params: [{ name: "include_implicit", type: "boolean" }],
		origin: "harvested",
	}, // func.sgml
	current_setting: {
	...
	current_timestamp: {
		...
		params: [{ name: "integer", optional: true }],
		origin: "harvested",
	}, // func.sgml
	...
	enum_range: {
		name: "enum_range",
		params: [{ name: "anyenum" }, { name: "anyenum", optional: true }],
		origin: "harvested",
	}, // func.sgml
	...
	pg_char_to_encoding: {
		...
		params: [{ name: "encoding", type: "name" }],
		origin: "harvested",
	}, // func.sgml
	...
	pg_collation_is_visible: {
		...
		params: [{ name: "collation", type: "oid" }],
		origin: "harvested",
	}, // func.sgml
	...
	pg_conversion_is_visible: {
		...
		params: [{ name: "conversion", type: "oid" }],
		origin: "harvested",
	}, // func.sgml
	...
	pg_drop_replication_slot: {
		...
		params: [{ name: "slot_name", type: "name" }],
		origin: "harvested",
	}, // func.sgml
	pg_encoding_to_char: {
		name: "pg_encoding_to_char",
		params: [{ name: "encoding", type: "integer" }],
		origin: "harvested",
	}, // func.sgml
	...
	pg_ls_replslotdir: {
		...
		params: [{ name: "slot_name", type: "text" }],
		origin: "harvested",
	}, // func.sgml
	pg_ls_summariesdir: { name: "pg_ls_summariesdir", params: [], origin: "harvested" }, // func.sgml
	pg_ls_tmpdir: {
		name: "pg_ls_tmpdir",
		params: [{ name: "tablespace", type: "oid", optional: true }],
		origin: "harvested",
	}, // func.sgml
	...
	pg_opclass_is_visible: {
		...
		params: [{ name: "opclass", type: "oid" }],
		origin: "harvested",
	}, // func.sgml
	pg_operator_is_visible: {
		name: "pg_operator_is_visible",
		params: [{ name: "operator", type: "oid" }],
		origin: "harvested",
	}, // func.sgml
	...
	pg_options_to_table: {
		...
		params: [{ name: "options_array", type: "text[]" }],
		origin: "harvested",
	}, // func.sgml
	...
	pg_relation_filenode: {
		...
		params: [{ name: "relation", type: "regclass" }],
		origin: "harvested",
	}, // func.sgml
	...
	pg_split_walfile_name: {
		...
		params: [{ name: "file_name", type: "text" }],
		origin: "harvested",
	}, // func.sgml
	pg_stat_file: {
		name: "pg_stat_file",
	...
	pg_tablespace_databases: {
		...
		params: [{ name: "tablespace", type: "oid" }],
		origin: "harvested",
	}, // func.sgml
	...
	pg_ts_config_is_visible: {
		...
		params: [{ name: "config", type: "oid" }],
		origin: "harvested",
	}, // func.sgml
	pg_ts_dict_is_visible: {
		name: "pg_ts_dict_is_visible",
		params: [{ name: "dict", type: "oid" }],
		origin: "harvested",
	}, // func.sgml
	pg_ts_parser_is_visible: {
		name: "pg_ts_parser_is_visible",
		params: [{ name: "parser", type: "oid" }],
		origin: "harvested",
	}, // func.sgml
	pg_ts_template_is_visible: {
		name: "pg_ts_template_is_visible",
		params: [{ name: "template", type: "oid" }],
		origin: "harvested",
	}, // func.sgml
	...
	pg_visible_in_snapshot: {
		...
		params: [{ name: "xid8" }, { name: "pg_snapshot" }],
		origin: "harvested",
	}, // func.sgml
	pg_wal_lsn_diff: {
	...
	row_to_json: {
		name: "row_to_json",
		params: [{ name: "record" }, { name: "boolean", optional: true }],
		origin: "harvested",
	}, // func.sgml
	rpad: {
		name: "rpad",
