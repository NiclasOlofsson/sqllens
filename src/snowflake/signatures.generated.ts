...
// Built 2026-07-14. 516 signatures (38 curated, 478 harvested).
...
export const SNOWFLAKE_SIGNATURES: Record<string, FnSignature> = {
	...
	approx_percentile: {
		...
		params: [{ name: "expr" }, { name: "percentile" }],
		origin: "harvested",
	...
	approx_percentile_combine: { name: "APPROX_PERCENTILE_COMBINE", params: [{ name: "state" }], origin: "harvested" }, // functions/approx_percentile_combine/1.txt
	...
	approx_top_k_accumulate: {
		...
		params: [{ name: "expr" }, { name: "counters" }],
		origin: "harvested",
	...
	array_contains: {
		name: "ARRAY_CONTAINS",
		params: [{ name: "value_expr" }, { name: "array" }],
		origin: "harvested",
	...
	array_position: {
		name: "ARRAY_POSITION",
		params: [{ name: "variant_expr" }, { name: "array" }],
		origin: "harvested",
	}, // functions/array_position/1.txt
	array_prepend: { name: "ARRAY_PREPEND", params: [{ name: "array" }, { name: "new_element" }], origin: "harvested" }, // functions/array_prepend/1.txt
	array_remove: {
		name: "ARRAY_REMOVE",
	...
	array_remove_at: {
		...
		params: [{ name: "array" }, { name: "position" }],
		origin: "harvested",
	...
	array_slice: {
		name: "ARRAY_SLICE",
		params: [{ name: "array" }, { name: "from" }, { name: "to" }],
		origin: "harvested",
	...
	array_to_string: {
		...
		params: [{ name: "array" }, { name: "separator_string" }],
		origin: "harvested",
	...
	arrays_to_object: {
		...
		params: [{ name: "key_array" }, { name: "value_array" }],
		origin: "harvested",
	...
	datasketches_hll_estimate: {
		name: "DATASKETCHES_HLL_ESTIMATE",
		params: [{ name: "binary_sketch" }],
		origin: "harvested",
	}, // functions/datasketches_hll_estimate/1.txt
	date: { name: "DATE", params: [{ name: "string_expr" }, { name: "format", optional: true }], origin: "harvested" }, // functions/to_date/1.txt
	date_from_parts: {
	...
	get_path: { name: "GET_PATH", params: [{ name: "column_identifier" }, { name: "path_name" }], origin: "harvested" }, // functions/get_path/1.txt
	get_query_operator_stats: { name: "GET_QUERY_OPERATOR_STATS", params: [{ name: "query_id" }], origin: "harvested" }, // functions/get_query_operator_stats/1.txt
	...
	h3_compact_cells_strings: {
		name: "H3_COMPACT_CELLS_STRINGS",
		params: [{ name: "array_of_cell_ids" }],
		origin: "harvested",
	...
	h3_grid_distance: {
		...
		params: [{ name: "cell_id_1" }, { name: "cell_id_2" }],
		origin: "harvested",
	}, // functions/h3_grid_distance/1.txt
	h3_grid_path: { name: "H3_GRID_PATH", params: [{ name: "cell_id_1" }, { name: "cell_id_2" }], origin: "harvested" }, // functions/h3_grid_path/1.txt
	...
	h3_try_grid_distance: {
		name: "H3_TRY_GRID_DISTANCE",
		params: [{ name: "cell_id_1" }, { name: "cell_id_2" }],
		origin: "harvested",
	}, // functions/h3_try_grid_distance/1.txt
	h3_try_grid_path: {
		name: "H3_TRY_GRID_PATH",
		params: [{ name: "cell_id_1" }, { name: "cell_id_2" }],
		origin: "harvested",
	...
	hex_encode: {
		name: "HEX_ENCODE",
		params: [{ name: "input" }, { name: "case", optional: true }],
		origin: "harvested",
	...
	initcap: {
		name: "INITCAP",
		params: [{ name: "expr" }, { name: "delimiters", optional: true }],
		origin: "harvested",
	...
	is_organization_user_group: { name: "IS_ORGANIZATION_USER_GROUP", params: [{ name: "role" }], origin: "harvested" }, // functions/is_organization_user_group/1.txt
	...
	months_between: {
		name: "MONTHS_BETWEEN",
		params: [{ name: "date_expr1" }, { name: "date_expr2" }],
		origin: "harvested",
	}, // functions/months_between/1.txt
	next_day: {
		name: "NEXT_DAY",
		params: [{ name: "date_or_timestamp_expr" }, { name: "dow_string" }],
		origin: "harvested",
	...
	previous_day: {
		name: "PREVIOUS_DAY",
		params: [{ name: "date_or_timestamp_expr" }, { name: "dow" }],
		origin: "harvested",
	...
	search_ip: { name: "SEARCH_IP", params: [{ name: "search_data" }, { name: "search_string" }], origin: "harvested" }, // functions/search_ip/1.txt
	...
	st_asgeojson: { name: "ST_ASGEOJSON", params: [{ name: "geography_or_geometry_expression" }], origin: "harvested" }, // functions/st_asgeojson/1.txt
	...
	st_buffer: {
		name: "ST_BUFFER",
		params: [{ name: "geometry_expression" }, { name: "distance" }],
		origin: "harvested",
	...
	st_dimension: { name: "ST_DIMENSION", params: [{ name: "geography_or_geometry_expression" }], origin: "harvested" }, // functions/st_dimension/1.txt
	st_distance: {
		name: "ST_DISTANCE",
	...
	st_makegeompoint: {
		...
		params: [{ name: "longitude" }, { name: "latitude" }],
		origin: "harvested",
	}, // functions/st_makegeompoint/1.txt
	st_makepoint: { name: "ST_MAKEPOINT", params: [{ name: "longitude" }, { name: "latitude" }], origin: "harvested" }, // functions/st_makepoint/1.txt
	st_makepolygon: {
		name: "ST_MAKEPOLYGON",
		params: [{ name: "geography_or_geometry_expression" }],
		origin: "harvested",
	}, // functions/st_makepolygon/1.txt
	st_makepolygonoriented: {
		name: "ST_MAKEPOLYGONORIENTED",
		params: [{ name: "geography_expression" }],
		origin: "harvested",
	...
	st_perimeter: { name: "ST_PERIMETER", params: [{ name: "geography_or_geometry_expression" }], origin: "harvested" }, // functions/st_perimeter/1.txt
	st_pointn: {
		name: "ST_POINTN",
	...
	st_setsrid: {
		name: "ST_SETSRID",
		params: [{ name: "geometry_expression" }, { name: "srid" }],
		origin: "harvested",
	...
	to_decfloat: {
		name: "TO_DECFLOAT",
		params: [{ name: "expr" }, { name: "format", optional: true }],
		origin: "harvested",
	...
	vector_cosine_similarity: {
		...
		params: [{ name: "vector" }, { name: "vector" }],
		origin: "harvested",
	...
	vector_truncate: {
		name: "VECTOR_TRUNCATE",
		params: [{ name: "vector" }, { name: "dimension" }],
		origin: "harvested",
