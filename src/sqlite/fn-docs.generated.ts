...
export const SQLITE_FN_DOCS: Record<string, FnDoc> = {
	...
	avg: {
		docUrl: "https://sqlite.org/lang_aggfunc.html",
	...
	iif: { description: "The iif(B1,V1,...,BN,VN) function takes arguments in pairs.", origin: "vendor-docs" },
	instr: {
		docUrl: "https://sqlite.org/lang_corefunc.html",
		description:
	...
	json: {
		docUrl: "https://sqlite.org/json1.html",
		description:
