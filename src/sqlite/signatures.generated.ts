...
// Built 2026-07-14. 39 names (39 curated, 0 harvested), 0 with 2+ overloads.
...
export const SQLITE_SIGNATURES: Record<string, FnSignature[]> = {
	...
	], // curated: mod(X,Y) - lang_mathfunc.html
	...
	], // curated: power(X,Y) - lang_mathfunc.html
	printf: [
		{
			name: "printf",
	...
	], // curated: substr(X,Y,Z) / substr(X,Y)
