...
import { referencesAt, type SchemaProvider, type Sym, type SqlDocument } from "../../index.js";
...
export function computeCodeLens(doc: SqlDocument, schema?: SchemaProvider): CodeLens[] {
	try {
		const out: CodeLens[] = [];
