...
// Built 2026-07-14. 306 signatures (36 curated, 270 harvested).
...
export const BIGQUERY_SIGNATURES: Record<string, FnSignature> = {
	...
	array_concat: { name: "ARRAY_CONCAT", params: [{ name: "array_expression" }], variadic: true, origin: "harvested" }, // array_functions.md
	...
	code_points_to_bytes: {
		...
		params: [{ name: "ascii_code_points" }],
		origin: "harvested",
	}, // string_functions.md
	code_points_to_string: {
		name: "CODE_POINTS_TO_STRING",
		params: [{ name: "unicode_code_points" }],
		origin: "harvested",
	}, // string_functions.md
	...
	current_date: {
		name: "CURRENT_DATE",
		params: [{ name: "time_zone_expression", optional: true }],
		origin: "harvested",
	}, // date_functions.md
	...
	format_time: {
		name: "FORMAT_TIME",
		params: [{ name: "format_string" }, { name: "time_expr" }],
		origin: "harvested",
	}, // time_functions.md
	format_timestamp: {
	...
	json_contains: {
		name: "JSON_CONTAINS",
		params: [{ name: "json_expr" }, { name: "json_expr" }],
		origin: "harvested",
	}, // json_functions.md
	...
	parse_time: {
		name: "PARSE_TIME",
		params: [{ name: "format_string" }, { name: "time_string" }],
		origin: "harvested",
	}, // time_functions.md
	parse_timestamp: {
	...
	proto_default_if_null: {
		...
		params: [{ name: "proto_field_expression" }],
		origin: "harvested",
	}, // protocol_buffer_functions.md
	...
	range_bucket: {
		name: "RANGE_BUCKET",
		params: [{ name: "point" }, { name: "boundaries_array" }],
		origin: "harvested",
	}, // mathematical_functions.md
	range_end: { name: "RANGE_END", params: [{ name: "range_to_check" }], origin: "harvested" }, // range-functions.md
	range_intersect: {
		name: "RANGE_INTERSECT",
		params: [{ name: "range_a" }, { name: "range_b" }],
		origin: "harvested",
	}, // range-functions.md
	range_overlaps: { name: "RANGE_OVERLAPS", params: [{ name: "range_a" }, { name: "range_b" }], origin: "harvested" }, // range-functions.md
	range_start: { name: "RANGE_START", params: [{ name: "range_to_check" }], origin: "harvested" }, // range-functions.md
	regexp_contains: { name: "REGEXP_CONTAINS", params: [{ name: "value" }, { name: "regexp" }], origin: "harvested" }, // string_functions.md
	regexp_extract: {
		name: "REGEXP_EXTRACT",
		params: [
	...
	st_contains: {
		name: "ST_CONTAINS",
		params: [{ name: "geography_1" }, { name: "geography_2" }],
		origin: "harvested",
	}, // geography_functions.md
	...
	st_geogpoint: { name: "ST_GEOGPOINT", params: [{ name: "longitude" }, { name: "latitude" }], origin: "harvested" }, // geography_functions.md
	...
	st_makepolygonoriented: {
		...
		params: [{ name: "array_of_geography" }],
		origin: "harvested",
	}, // geography_functions.md
	st_maxdistance: {
		name: "ST_MAXDISTANCE",
	...
	st_pointn: {
		name: "ST_POINTN",
		params: [{ name: "linestring_geography" }, { name: "index" }],
		origin: "harvested",
	}, // geography_functions.md
	st_simplify: {
		name: "ST_SIMPLIFY",
		params: [{ name: "geography" }, { name: "tolerance_meters" }],
		origin: "harvested",
	}, // geography_functions.md
	st_snaptogrid: {
		name: "ST_SNAPTOGRID",
	...
	st_touches: { name: "ST_TOUCHES", params: [{ name: "geography_1" }, { name: "geography_2" }], origin: "harvested" }, // geography_functions.md
	...
	time_trunc: {
		name: "TIME_TRUNC",
		params: [{ name: "time_value" }, { name: "time_granularity" }],
		origin: "harvested",
	}, // time_functions.md
	timestamp_bucket: {
