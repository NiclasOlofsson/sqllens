...
// Built 2026-07-14. 205 signatures (38 curated, 167 harvested).
...
export const TSQL_SIGNATURES: Record<string, FnSignature> = {
	...
	collationproperty: {
		...
		params: [{ name: "collation_name" }, { name: "property" }],
		origin: "harvested",
	...
	databasepropertyex: {
		...
		params: [{ name: "database" }, { name: "property" }],
		origin: "harvested",
	...
	edge_id_from_parts: {
		...
		params: [{ name: "object_id" }, { name: "graph_id" }],
		origin: "harvested",
	...
	filegroupproperty: {
		...
		params: [{ name: "filegroup_name" }, { name: "property" }],
		origin: "harvested",
	}, // functions/filegroupproperty-transact-sql.md
	fileproperty: { name: "FILEPROPERTY", params: [{ name: "file_name" }, { name: "property" }], origin: "harvested" }, // functions/fileproperty-transact-sql.md
	...
	first_value: { name: "FIRST_VALUE", params: [{ name: "scalar_expression", optional: true }], origin: "harvested" }, // functions/first-value-transact-sql.md
	...
	get_filestream_transaction_context: { name: "GET_FILESTREAM_TRANSACTION_CONTEXT", params: [], origin: "harvested" }, // functions/get-filestream-transaction-context-transact-sql.md
	...
	left_shift: {
		name: "LEFT_SHIFT",
		params: [{ name: "expression_value" }, { name: "shift_amount" }],
		origin: "harvested",
	...
	log: { name: "LOG", params: [{ name: "float_expression" }, { name: "base", optional: true }], origin: "harvested" }, // functions/log-transact-sql.md
	...
	objectpropertyex: { name: "OBJECTPROPERTYEX", params: [{ name: "id" }, { name: "property" }], origin: "harvested" }, // functions/objectpropertyex-transact-sql.md
	openjson: {
		name: "OPENJSON",
	...
	sql_variant_property: {
		...
		params: [{ name: "expression" }, { name: "property" }],
		origin: "harvested",
	...
	vector_normalize: {
		...
		params: [{ name: "vector" }, { name: "norm_type" }],
		origin: "harvested",
	}, // functions/vector-normalize-transact-sql.md
	vectorproperty: { name: "VECTORPROPERTY", params: [{ name: "vector" }, { name: "property" }], origin: "harvested" }, // functions/vectorproperty-transact-sql.md
