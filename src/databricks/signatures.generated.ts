...
// Built 2026-07-14. 640 signatures (41 curated, 599 harvested).
...
export const DATABRICKS_SIGNATURES: Record<string, FnSignature> = {
	...
	array_insert: {
		name: "array_insert",
		params: [{ name: "array" }, { name: "index" }, { name: "elem" }],
		origin: "harvested",
	}, // functions/array_insert/1.txt
	array_intersect: { name: "array_intersect", params: [{ name: "array1" }, { name: "array2" }], origin: "harvested" }, // functions/array_intersect/1.txt
	array_join: {
		name: "array_join",
	...
	bround: {
		name: "bround",
		params: [{ name: "expr" }, { name: "targetScale", optional: true }],
		origin: "harvested",
	...
	find_in_set: { name: "find_in_set", params: [{ name: "searchExpr" }, { name: "sourceExpr" }], origin: "harvested" }, // functions/find_in_set/1.txt
	...
	from_unixtime: {
		name: "from_unixtime",
		params: [{ name: "unixTime" }, { name: "fmt", optional: true }],
		origin: "harvested",
	}, // functions/from_unixtime/1.txt
	from_utc_timestamp: {
		name: "from_utc_timestamp",
		params: [{ name: "expr" }, { name: "timeZone" }],
		origin: "harvested",
	...
	greatest: { name: "greatest", params: [{ name: "expr1" }, { name: "expr2" }], variadic: true, origin: "harvested" }, // functions/greatest/1.txt
	...
	h3_kringdistances: {
		...
		params: [{ name: "h3CellIdExpr" }, { name: "kExpr" }],
		origin: "harvested",
	...
	h3_maxchild: {
		name: "h3_maxchild",
		params: [{ name: "h3cellIdExpr" }, { name: "resolutionExpr" }],
		origin: "harvested",
	...
	h3_uncompact: {
		name: "h3_uncompact",
		params: [{ name: "h3CellIdsExpr" }, { name: "resolutionExpr" }],
		origin: "harvested",
	...
	ip_cidr_contains: { name: "ip_cidr_contains", params: [{ name: "cidr" }, { name: "needle" }], origin: "harvested" }, // functions/ip_cidr_contains/1.txt
	...
	json_tuple: {
		name: "json_tuple",
		params: [{ name: "jsonStr" }, { name: "path1" }],
		variadic: true,
		origin: "harvested",
	...
	kll_sketch_merge_bigint: {
		...
		params: [{ name: "sketch1" }, { name: "sketch2" }],
		origin: "harvested",
	...
	make_time: {
		name: "make_time",
		params: [{ name: "hour" }, { name: "minute" }, { name: "second" }],
		origin: "harvested",
	...
	map_zip_with: {
		name: "map_zip_with",
		params: [{ name: "map1" }, { name: "map2" }, { name: "func" }],
		origin: "harvested",
	...
	mode: { name: "mode", params: [{ name: "expr" }, { name: "deterministic", optional: true }], origin: "harvested" }, // functions/mode/1.txt
	...
	schema_of_csv: {
		name: "schema_of_csv",
		params: [{ name: "csv" }, { name: "options", optional: true }],
		origin: "harvested",
	...
	session_window: {
		name: "session_window",
		params: [{ name: "expr" }, { name: "gapDuration" }],
		origin: "harvested",
	...
	shiftrightunsigned: { name: "shiftrightunsigned", params: [{ name: "expr" }, { name: "n" }], origin: "harvested" }, // functions/shiftrightunsigned/1.txt
	...
	st_closestpoint: {
		...
		params: [{ name: "geoExpr1" }, { name: "geoExpr2" }],
		origin: "harvested",
	...
	st_difference: { name: "st_difference", params: [{ name: "geoExpr1" }, { name: "geoExpr2" }], origin: "harvested" }, // functions/st_difference/1.txt
	...
	st_interiorringn: {
		...
		params: [{ name: "geoExpr" }, { name: "indexExpr" }],
		origin: "harvested",
	...
	st_intersects: { name: "st_intersects", params: [{ name: "geoExpr1" }, { name: "geoExpr2" }], origin: "harvested" }, // functions/st_intersects/1.txt
	...
	to_binary: { name: "to_binary", params: [{ name: "expr" }, { name: "fmt", optional: true }], origin: "harvested" }, // functions/to_binary/1.txt
	...
	to_json: { name: "to_json", params: [{ name: "expr" }, { name: "options", optional: true }], origin: "harvested" }, // functions/to_json/1.txt
	...
	to_unix_timestamp: {
		...
		params: [{ name: "expr" }, { name: "fmt", optional: true }],
		origin: "harvested",
	...
	try_multiply: {
		name: "try_multiply",
		params: [{ name: "multiplier" }, { name: "multiplicand" }],
		origin: "harvested",
	...
	tuple_sketch_theta_double: { name: "tuple_sketch_theta_double", params: [{ name: "sketch" }], origin: "harvested" }, // functions/tuple_sketch_theta_double/1.txt
	tuple_sketch_theta_integer: {
		name: "tuple_sketch_theta_integer",
		params: [{ name: "sketch" }],
		origin: "harvested",
	...
	vector_cosine_similarity: {
		...
		params: [{ name: "vector1" }, { name: "vector2" }],
		origin: "harvested",
	...
	zip_with: {
		name: "zip_with",
		params: [{ name: "expr1" }, { name: "expr2" }, { name: "func" }],
		origin: "harvested",
