// Deterministic corpus MUTATOR — the volume half of the eight dialects' negative side (issue #5).
//
...
//
// Run:  node tools/mutate-corpus.mjs            (all eight dialects)
...
const DIALECTS = ["databricks", "tsql", "snowflake", "redshift", "postgres", "duckdb", "trino", "sqlite"];
